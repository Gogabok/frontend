...
/**
 * Component that lets user edit the avatar.
 */
@Component({
    components: {
        ...
        'vue-cropper': ()=> import(/* webpackPrefetch: true */ 'vue-cropperjs'),
...
export default class AvatarEditor extends Vue {
    ...
    /**
     * Rotates image for `deg` degrees.
     *
     * @param deg                       Amount of degrees to rotate image to.
     */
    ...
    /**
     * Sends `update-avatar` event with updates image data.
