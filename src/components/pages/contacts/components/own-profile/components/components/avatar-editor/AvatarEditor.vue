  ...
  .avatar-editor
    ...
    .avatar-editor__controls
      button.avatar-editor__controls__button.close(@click="close")
        plus-icon
      button.avatar-editor__controls__button.zoom.zoom-in(
        @click.prevent="zoom(0.2)",
      )
        zoom-in-icon
      button.avatar-editor__controls__button.rotate(
        @click="rotate(90)",
      )
        rotate-icon
      button.avatar-editor__controls__button.zoom.zoom-out(
        @click.prevent="zoom(-0.2)",
      )
        zoom-out-icon

      button.avatar-editor__controls__button.accept(
        @click="acceptCrop",
      )
        accept-icon
</template>
